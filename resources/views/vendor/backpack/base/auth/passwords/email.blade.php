        ...
        <div class="col-md-4 col-md-offset-4">
            ...
            <div class="nav-steps-wrapper">
                <ul class="nav nav-tabs nav-steps">
                  <li class="active"><a href="#tab_1" data-toggle="tab"><strong>{{ trans('auth.step') }} 1.</strong> {{ trans('auth.confirm_email') }}</a></li>
                  <li><a class="disabled text-muted"><strong>{{ trans('auth.step') }} 2.</strong> {{ trans('auth.choose_new_password') }}</a></li>
                </ul>
            </div>
