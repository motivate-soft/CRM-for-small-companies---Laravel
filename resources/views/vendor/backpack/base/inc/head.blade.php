...
@if(backpack_user())
    @switch(backpack_user()->role)
        @case('admin')
            <link rel="stylesheet" href="{{ asset('css/panels/admin.css') }}">
            @break;
        @case('company')
            <link rel="stylesheet" href="{{ asset('css/panels/company.css') }}">
            @break;
        @case('employee')
            <link rel="stylesheet" href="{{ asset('css/panels/employee.css') }}">
            @break;
    @endswitch
@endif
