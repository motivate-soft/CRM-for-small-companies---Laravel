            ...
            <div class="box-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th>{{ trans('fields.subscription_date') }}</th>
                        <th>{{ trans('fields.expire_date') }}</th>
                        <th>{{ trans('fields.left_days') }}</th>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            @if($item->plan)
                                ...
                                @endif
                                ">
                                {{ \App\Models\Plan::getPlanLabelList()[$item->plan] }}
                                </span>
                            @endif
                        </td>
                        <td>
                            @if($item->subscription_date)
                                {{ \Carbon\Carbon::parse($item->subscription_date)->format('d M Y') }}
                        ...
                        <td class="text-center">
                            ...
                            @endif
                                    @php
                                        if ($item->expire_date < \Carbon\Carbon::now()) {
                                            $percentage = 0;
                                        } else {

                                            $total = \Carbon\Carbon::parse($item->subscription_date)->diffInDays($item->expire_date);
                                            $percentage = $item->left_days/$total * 100;
                                        }
                                    @endphp
                        ...
                        <td>
                            <a class="btn btn-xs btn-default" href="{{ url('trial_mode/edit/' . $item->id) }}" data-toggle="tooltip" ><i class="fa fa-edit"></i> {{ trans('backpack::crud.edit') }}</a>
                        </td>
                    </tr>
                    @endforeach
                    </tbody>
