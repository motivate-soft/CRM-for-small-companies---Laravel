...
@section('content')
    <div class="row">
        <div class="col-md-4">
            <form class="form" action="{{ route('company_change_password', ['id' => $id]) }}" method="post">
                ...
                <div class="box padding-10">
                    ...
                    <div class="box-body backpack-profile-form">
                        ...
                        <div class="form-group m-b-0">
                            ...
                            <a href="{{ backpack_url() }}/companies" class="btn btn-default"><span class="ladda-label">{{ trans('backpack::base.cancel') }}</span></a>
