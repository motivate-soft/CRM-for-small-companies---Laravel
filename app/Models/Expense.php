...
class Expense extends Model
{
    ...
    protected $fillable = ['status', 'date', 'employee_id', 'event_type_id', 'photo', 'comment', 'amount', 'reject_message', 'company_is_read', 'employee_is_read'];
    ...
    {
        $this->uploadFileToDisk($value, 'photo', 'uploads', 'medical_day/' . backpack_user()->employee->id);
    }
    ...
    public function setPhotoAttribute($value)
    {
        ...
        $disk = "uploads";
        $destination_path = 'expenses/' . $this->id;
